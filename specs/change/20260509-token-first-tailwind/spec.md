...
- [ ] Step 5: 建立程序化视觉回归基线
  ...
  - [ ] Substep 5.6 Implement: 在 `phase1-notes.md` 记录 foundation changes、迁移清单、视觉 baseline artifacts 和批准 deviations。
...
- [ ] Step 7: 程序化验证 shell 与通用 controls 视觉等价
  ...
  - [ ] Substep 7.2 Implement: 在 `phase2-notes.md` 记录本 phase 的 migrated / retained / deferred class 清单、视觉 diff artifacts 和批准 deviations。
...
- [ ] Step 9: 程序化验证 settings 与 project panel 视觉等价
  ...
  - [ ] Substep 9.2 Implement: 在 `phase3-notes.md` 记录本 phase 的 migrated / retained / deferred class 清单、视觉 diff artifacts 和批准 deviations。
...
- [ ] Step 11: 程序化验证 file viewer 与 inspect/edit-mode overlays 视觉等价
  ...
  - [ ] Substep 11.2 Implement: 在 `phase4-notes.md` 记录本 phase 的 migrated / retained / deferred class 清单、视觉 diff artifacts 和批准 deviations。
...
- [ ] Step 13: 程序化验证 sketch 与 runtime content 边界视觉等价
  ...
  - [ ] Substep 13.2 Implement: 在 `phase5-notes.md` 记录本 phase 的 migrated / retained / deferred class 清单、视觉 diff artifacts 和批准 deviations。
...
- [ ] Step 14: 收尾清理与强约束
  ...
  - [ ] Substep 14.4 Implement: 在 `phase6-notes.md` 记录最终 implementation notes、迁移清单结果和任何批准的 deviations。
...
- [ ] Step 15: 程序化验证最终视觉等价
  ...
  - [ ] Substep 15.2 Implement: 在 `phase6-notes.md` 记录最终视觉 diff artifacts 和任何批准的 deviations。

## Notes

Phase notes are split by PR phase so each implementation slice can update its own notes file:

- `phase1-notes.md` - Foundation PR notes, migration inventory, and visual baseline.
- `phase2-notes.md` - Shell/common controls migration notes and visual diff artifacts.
- `phase3-notes.md` - Settings/project panels migration notes and visual diff artifacts.
- `phase4-notes.md` - File viewer/inspect/edit-mode migration notes and visual diff artifacts.
- `phase5-notes.md` - Sketch/runtime content migration notes and visual diff artifacts.
- `phase6-notes.md` - Cleanup/enforcement notes, final retained global CSS inventory, final visual diff artifacts, and approved deviations.
